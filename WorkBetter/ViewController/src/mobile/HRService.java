...
public class HRService {
    ...
    protected static List s_departments = new ArrayList();
    ...
    public HRService() {
        ...
        try {
            s_employees.add(new Employee(174, "Ellen", "Abel", "Sales Representative", 80, "Sales",
                                         "011.44.1644.429267", "011.44.1644.429267", "EABEL", "Ellen", "Ellen", "Ellen",
                                         "Ellen", "Magdalen Centre, The Oxford Science Park", "Oxford", "Oxford", "UK",
                                         "OX9 9ZB", 4, 4, 85, 11000, 2750, 3000, 149, sdf.parse("01-01-2010"), "Eleni",
                                         "Zlotkey"));
            s_employees.add(new Employee(166, "Sundar", "Ande", "Sales Representative", 80, "Sales",
                                         ...
                                         "Oxford", "UK", "OX9 9ZB", 4, 4, 90, 6400, 1600, 1000, 147,
            ...
            s_employees.add(new Employee(167, "Amit", "Banda", "Sales Representative", 80, "Sales",
                                         ...
                                         "OX9 9ZB", 3, 4, 115, 6200, 1550, 1000, 147, sdf.parse("03-01-2009"),
                                         "Allison", "Errazuriz"));
            s_employees.add(new Employee(172, "Elizabeth", "Bates", "Sales Representative", 80, "Sales",
                                         ...
                                         "Oxford", "UK", "OX9 9ZB", 4, 5, 110, 7300, 1825, 1500, 148,
            ...
            s_employees.add(new Employee(151, "Dannica", "Bernstein", "Sales Representative", 80, "Sales",
                                         ...
                                         "Oxford", "UK", "OX9 9ZB", 3, 4, 100, 9500, 2375, 2500, 145,
            ...
            s_employees.add(new Employee(169, "Harrison", "Bloom", "Sales Representative", 80, "Sales",
                                         ...
                                         sdf.parse("07-14-2006"), "Gerald", "Cambrault"));
            s_employees.add(new Employee(185, "Alexis", "Bull", "Shipping Clerk", 50, "Shipping", "650.509.2876",
                                         "650.509.2876", "ABULL", "Alexis", "Alexis", "Alexis", "Alexis",
                                         "2011 Main Street", "South San Francisco", "California", "US", "94105", 3, 4,
            ...
            s_employees.add(new Employee(154, "Nina", "Cambrault", "Sales Representative", 80, "Sales",
                                         ...
                                         "Oxford", "UK", "OX9 9ZB", 5, 4, 100, 7500, 1875, 2000, 145,
            ...
            s_employees.add(new Employee(110, "John", "Chen", "Accountant", 100, "Finance", "515.124.4269",
                                         ...
                                         "Seattle", "Washington", "US", "98102", 4, 4, 110, 8200, 2050, 0, 108,
            ...
            s_employees.add(new Employee(119, "Karen", "Colmenares", "Purchasing Clerk", 30, "Purchasing",
                                         ...
                                         625, 0, 114, sdf.parse("03-01-2009"), "Deb", "Raphaely"));
            ...
            s_employees.add(new Employee(104, "Bruce", "Ernst", "Programmer", 60, "IT", "590.423.4568", "590.423.4568",
                                         ...
                                         "Texas", "US", "76034", 4, 5, 85, 6000, 1500, 0, 103, sdf.parse("07-14-2006"),
                                         "Alexander", "Hunold"));
            ...
            s_employees.add(new Employee(109, "Daniel", "Faviet", "Accountant", 100, "Finance", "515.124.4169",
                                         ...
                                         2250, 0, 108, sdf.parse("02-14-2008"), "Nancy", "Greenberg"));
            ...
            s_employees.add(new Employee(108, "Nancy", "Greenberg", "Finance Manager", 100, "Finance", "515.124.4569",
                                         ...
                                         3000, 0, 101, sdf.parse("01-01-2010"), "Neena", "Kochhar"));
            s_employees.add(new Employee(163, "Danielle", "Greene", "Sales Representative", 80, "Sales",
                                         "011.44.1346.229268", "011.44.1346.229268", "DGREENE", "Danielle", "Danielle",
                                         "Danielle", "Danielle", "Magdalen Centre, The Oxford Science Park", "Oxford",
            ...
            s_employees.add(new Employee(201, "Michael", "Hartstein", "Marketing Manager", 20, "Marketing",
                                         ...
                                         13000, 3250, 0, 100, sdf.parse("09-14-2004"), "Steven", "King"));
            s_employees.add(new Employee(205, "Shelley", "Higgins", "Accounting Manager", 110, "Accounting",
                                         ...
                                         115, 12000, 3000, 0, 101, sdf.parse("01-01-2010"), "Neena", "Kochhar"));
            s_employees.add(new Employee(118, "Guy", "Himuro", "Purchasing Clerk", 30, "Purchasing", "515.127.4565",
                                         ...
                                         "Seattle", "Washington", "US", "98102", 4, 4, 110, 2600, 650, 0, 114,
            ...
            s_employees.add(new Employee(103, "Alexander", "Hunold", "Programmer", 60, "IT", "590.423.4567",
                                         ...
                                         "2014 Main St", "Southlake", "Texas", "US", "76034", 3, 4, 105, 9000, 2250, 0,
                                         102, sdf.parse("07-14-2006"), "Lex", "De Haan"));
            s_employees.add(new Employee(175, "Alyssa", "Hutton", "Sales Representative", 80, "Sales",
                                         "011.44.1644.429266", "011.44.1644.429266", "AHUTTON", "Alyssa", "Alyssa",
                                         "Alyssa", "Alyssa", "Magdalen Centre, The Oxford Science Park", "Oxford",
            ...
            s_employees.add(new Employee(179, "Charles", "Johnson", "Sales Representative", 80, "Sales",
                                         ...
                                         "Oxford", "UK", "OX9 9ZB", 0, 0, 95, 6200, 1550, 1000, 149,
            ...
            s_employees.add(new Employee(115, "Alexander", "Khoo", "Purchasing Clerk", 30, "Purchasing", "515.127.4562",
                                         ...
                                         "2004 Bellevue Ct", "Seattle", "Washington", "US", "98102", 3, 4, 90, 3100,
            ...
            s_employees.add(new Employee(101, "Neena", "Kochhar", "Administration Vice President", 90, "Executive",
                                         ...
                                         4250, 0, 100, sdf.parse("02-14-2008"), "Steven", "King"));
            s_employees.add(new Employee(173, "Sundita", "Kumar", "Sales Representative", 80, "Sales",
                                         "011.44.1343.329268", "011.44.1343.329268", "SKUMAR", "Sundita", "Sundita",
                                         "Sundita", "Sundita", "Magdalen Centre, The Oxford Science Park", "Oxford",
            ...
            s_employees.add(new Employee(165, "David", "Lee", "Sales Representative", 80, "Sales", "011.44.1346.529268",
                                         "011.44.1346.529268", "DLEE", "David", "David", "David", "David",
                                         "Magdalen Centre, The Oxford Science Park", "Oxford", "Oxford", "UK",
            ...
            s_employees.add(new Employee(107, "Diana", "Lorentz", "Programmer", 60, "IT", "590.423.5567",
                                         ...
                                         "Southlake", "Texas", "US", "76034", 3, 4, 95, 4200, 1050, 0, 103,
            ...
            s_employees.add(new Employee(168, "Lisa", "Ozer", "Sales Representative", 80, "Sales", "011.44.1343.929268",
                                         "011.44.1343.929268", "LOZER", "Lisa", "Lisa", "Lisa", "Lisa",
                                         "Magdalen Centre, The Oxford Science Park", "Oxford", "Oxford", "UK",
            ...
            s_employees.add(new Employee(113, "Luis", "Popp", "Accountant", 100, "Finance", "515.124.4567",
                                         ...
                                         "Seattle", "Washington", "US", "98102", 3, 4, 105, 6900, 1725, 0, 108,
            ...
            s_employees.add(new Employee(114, "Deb", "Raphaely", "Purchasing Manager", 30, "Purchasing", "515.127.4561",
                                         ...
                                         "Seattle", "Washington", "US", "98102", 5, 4, 95, 11000, 2750, 0, 100,
            ...
            s_employees.add(new Employee(145, "Joanne", "Russell", "Sales Manager", 80, "Sales", "011.44.1344.429268",
                                         ...
                                         "King"));
            s_employees.add(new Employee(184, "Nandita", "Sarchand", "Shipping Clerk", 50, "Shipping", "650.509.1876",
                                         "650.509.1876", "NSARCHAN", "Nandita", "Nandita", "Nandita", "Nandita",
                                         "2011 Main Street", "South San Francisco", "California", "US", "94105", 4, 5,
            ...
            s_employees.add(new Employee(111, "Ismael", "Sciarra", "Accountant", 100, "Finance", "515.124.4369",
                                         ...
                                         "2004 Bellevue Ct", "Seattle", "Washington", "US", "98102", 3, 4, 95, 7700,
            ...
            s_employees.add(new Employee(176, "Jonathon", "Taylor", "Sales Representative", 80, "Sales",
                                         "011.44.1644.429265", "011.44.1644.429265", "JTAYLOR", "Jonathon", "Jonathon",
                                         "Jonathon", "Jonathon", "Magdalen Centre, The Oxford Science Park", "Oxford",
            ...
            s_employees.add(new Employee(117, "Sigal", "Tobias", "Purchasing Clerk", 30, "Purchasing", "515.127.4564",
                                         ...
                                         700, 0, 114, sdf.parse("03-01-2009"), "Deb", "Raphaely"));
            ...
            s_employees.add(new Employee(112, "Jose Manuel", "Urman", "Accountant", 100, "Finance", "515.124.4469",
                                         ...
                                         5, 90, 7800, 1950, 0, 108, sdf.parse("01-01-2010"), "Nancy", "Greenberg"));
            ...
            s_employees.add(new Employee(162, "Clara", "Vishney", "Sales Representative", 80, "Sales",
                                         "011.44.1346.129268", "011.44.1346.129268", "CVISHNEY", "Clara", "Clara",
                                         "Clara", "Clara", "Magdalen Centre, The Oxford Science Park", "Oxford",
            ...
            s_departments.add(new Department(80, "Sales", "Magdalen Centre, The Oxford Science Park", "Oxford",
                                             "Oxford", "UK", "OX9 9ZB", 172, "Gerald", "Cambrault", "54.5608864", "-2.2125118", "#81bb5f"));
